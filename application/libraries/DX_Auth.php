...
class DX_Auth
{
	...
	*/
	...
	//重写register
	function register2($username, $password, $email, $role_id, $realname, $department, $banned, $memo, $identity, $phone, $access_type, $limit_login_address)
	{		
		// Load Models
		$this->ci->load->model('dx_auth/users', 'users');
		$this->ci->load->model('dx_auth/user_temp', 'user_temp');
		...
		$new_user = array(			
		    ...
		    'limit_login_address'  => $limit_login_address
		);
