...
class Logo2 extends CI_Controller
{	
	...
	function test()
	{
		$res = $this->Mlogo->test2()->result_array();
		var_dump($res);
	...
	function load_lgquery()
	{
	    ...
	    $data = array();
	    $data['place'] = $this->input->post('place') ? $this->input->post('place'): $lgquery['place'];
		$data['lane']  = $this->input->post('lane')  ? $this->input->post('lane') : $lgquery['lane'];
		$data['dire']  = $this->input->post('dire')  ? $this->input->post('dire') : $lgquery['dire'];
		$data['hpys']  = $this->input->post('hpys')  ? $this->input->post('hpys') : $lgquery['hpys'];
		$data['ppdm']  = $this->input->post('ppdm')  ? $this->input->post('ppdm') : $lgquery['ppdm'];
		$data['cllx']  = $this->input->post('cllx')  ? $this->input->post('cllx') : $lgquery['cllx'];
		$data['csys']  = $this->input->post('csys')  ? $this->input->post('csys') : $lgquery['csys'];
		$data['st']    = $this->input->post('st')    ? $this->input->post('st')   : $lgquery['st'];
		$data['et']    = $this->input->post('et')    ? $this->input->post('et')   : $lgquery['et'];
		#$data['number']= $this->input->post('number')? iconv("UTF-8","GBK//IGNORE",$this->input->post('number')) : $lgquery['number'];
		#$data['carnum']= $this->input->post('carnum')? iconv("UTF-8","GBK//IGNORE",$this->input->post('carnum')) : $lgquery['carnum'];
		#$data['number']= $this->input->post('number')? $this->input->post('number') : $lgquery['number'];
		#$data['carnum']= $this->input->post('carnum')? $this->input->post('carnum') : $lgquery['carnum'];
		$data['number'] = '?';
		$data['carnum'] = 'L31学%';
		#$data['platename'] = format_carnum($data['number'],$data['carnum']);
		$data['platename'] = '%L31学%';
		$lgquery = $this->session->set_userdata('lgquery',$data);
		#var_dump($this->input->post(NULL));
		#var_dump($data);
		$result["rows"]  = $this->lib_kakou->icon_to_utf8($this->Mlogo->get_carinfo3($offset,$rows,$sort,$order,$data)->result_array());
		$result["total"] = $this->Mlogo->get_carinfo3(0,0,'id','asc',$data)->row()->sum;
