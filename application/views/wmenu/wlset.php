...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="94%" valign="bottom"><span class="STYLE12">&nbsp;白名单车辆设置</span></td>
										</tr>
									</table>
								</td>
							</tr>
	...
	<tr>  
		<td>
	        ...
	        <form id="form2" name="form2" method="post" action="<?php echo site_url('wmenu/find_wl'); ?>">
			...
			<form method="post" action="<?php echo site_url('wmenu/add_wl_ok'); ?>">
			...
			<table align="center" width="95%" border="0" cellpadding="0" cellspacing="1" class="tab">
				...
				<tr>
                    ...
                    <td height="24" ><div align="center" class="STYLE23"><?php if($wl->CLBJ == 'F'){echo anchor('wmenu/edit_wl_check/'.$wl->ID,'审核');}else{echo '<lable style="color: #344b50; font-size: 12px;">已审核</lable>';}?> | <?php echo anchor('wmenu/del_wl_set/'.$wl->ID, '删除', 'onclick="return confirm(' . "'确定要删除？'" . ')"')?></div></td>
				</tr>
				<?php endforeach; ?>
				<tr>
				<?php else: ?>
