					...
					<td height="24" bgcolor="#353c44">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
                                ...
                                <td><div align="right"><span class="STYLE1">      &nbsp;&nbsp;<img src="images/admin/add.gif" width="10" height="10" />&nbsp;&nbsp;<?php echo anchor('syst/add_sysset/', '添加'); ?>&nbsp; &nbsp;</span><span class="STYLE1"> &nbsp;</span></div></td>
							</tr>
						</table>
					</td>
				</tr>
		...
		<td>
			<table align="center" width="95%" border="0" cellpadding="0" cellspacing="1" class="tab">
				...
				<?php if (!empty($config_info)): ?>
					...
					<td height="20" bgcolor="#4e87d6" class="STYLE6"><div align="center"><span class="STYLE11">别名</span></div></td>
					<td height="20" bgcolor="#4e87d6" class="STYLE6"><div align="center"><span class="STYLE11">卡口类型</span></div></td>
					<td height="20" bgcolor="#4e87d6" class="STYLE6"><div align="center"><span class="STYLE11">操作</span></div></td>
				</tr>
				<?php $rownum = 0;?>
				<?php foreach ($config_info as $row): ?>
				<tr>
				    <td height="24" ><div align="center" class="STYLE23"><?php echo $rownum += 1; ?></div></td>	
					<td height="20" ><div align="center" class="STYLE23"><?php echo $row->TYPE_VALUE?></div></td>
					<td height="20" ><div align="center" class="STYLE23"><?php echo $row->TYPE_ALIAS?></div></td>
					<td height="20" ><div align="center" class="STYLE23"><?php echo $row->TYPE_DEF == 1 ? '电警' : '卡口' ?></div></td>
                    <td height="20" ><div align="center" class="STYLE23"><?php echo anchor('syst/edit_sysset/'.$row->ID,'修改')?> | <?php echo anchor('syst/del_sysset/'.$row->ID, '删除', 'onclick="return confirm(' . "'确定要删除？'" . ')"')?></div></td>
				</tr>
				<?php endforeach; ?>
				<tr>
				<?php else: ?>
