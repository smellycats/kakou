	    ...
	    $('#container').highcharts({
	        ...
	        xAxis: {
	            ...
	            labels: {
	                ...
	                style: {
	                    fontSize: '14px',
	                    fontFamily: '黑体,Verdana, sans-serif'
	                }
	            }
	        },
	        yAxis: {
	        ...
	        tooltip: {
	            pointFormat: '车辆数目: <b>{point.y} 辆</b>',
	            shared: true,
	            useHTML: true
	        },
	        series: [{
...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
									...
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE12">&nbsp;报警统计</span></td>
											</tr>
										</table>
									</td>
								</tr>
		...
		<tr>
	        <form method="post" action="<?php echo site_url('stat/bjsum_search2'); ?>">
			<div align="center">
			<table align="center" width="100%" border="1" cellspacing="0" bordercolor="#639CBF">
		      <tr bordercolor="#E6E6E6">
	            ...
	            <td width="18%" bordercolor="#E6E6E6">
	                <select name="cartype">
	            ...
	            <td width="25%" align="center" bordercolor="#E6E6E6" style="font-size: 12px;"><span>显示方式:</span>
	                <span>
			  ...
			  <tr>
	            ...
	            <td bordercolor="#E6E6E6" style="font-size: 12px;"><span>报警类型:</span></td>
	            <td bordercolor="#E6E6E6">
	            ...
	            <td bordercolor="#E6E6E6" style="font-size: 12px;"><span>处理状态:</span></td>
	            <td bordercolor="#E6E6E6">
	                <select name="dispose">
