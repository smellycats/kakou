...
function loadDataP(){
	window.location.href=<?php echo '"' . base_url() .  'index.php/gate/slshowdetail/?type_alias=' . $type_alias . "&lane=" . $lane . "&direction=" . $direction . "&color=" . $color . "&number=" . $number . "&carnum=" . $carnum . "&starttime=" . $starttime . "&endtime=" . $endtime . "&spcarnum=" . $spcarnum . "&per_page=" . $per_page . '&rownum=' . ($rownum-1) . '"'?>;
}
...
function comeback(){
	window.location.href=<?php echo '"' . base_url() .  'index.php/gate/slquery_ok/?type_alias=' . $type_alias . "&lane=" . $lane . "&direction=" . $direction . "&color=" . $color . "&number=" . $number . "&carnum=" . $carnum . "&starttime=" . $starttime . "&endtime=" . $endtime . "&spcarnum=" . $spcarnum . "&per_page=" . $per_page .  '"'?>;
}
</script>
