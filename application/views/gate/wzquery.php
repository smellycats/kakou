...
<body>
	...
	<div id="tb" style="padding:3px">
		<div align="center">
			...
			<span>违法类型:</span>
			<input id="breakrule" class="easyui-combobox" style="width:100px"
					url = "<?php echo base_url() . 'index.php/basedata/get_breakrule';?>" 
					method = "get" valueField = "id" textField = "text" panelHeight = "auto" />
			<span>记录状态:</span>
			<input id="record" class="easyui-combobox" style="width:60px"
					url = "<?php echo base_url() . 'index.php/basedata/get_record';?>" 
					method = "get" valueField = "id" textField = "text" panelHeight = "auto" />	
			<span>号牌颜色:</span>
			<input id="hpys" class="easyui-combobox" style="width:50px"
					...
					method = "get" valueField = "id" textField = "text" panelHeight = "auto" />
			<span>车速:</span>
			<input id="minspeed" class="easyui-numberbox" style="width:40px" data-options="min:0,max:1000" />
			<span>-</span>
			<input id="maxspeed" class="easyui-numberbox" style="width:40px" data-options="min:0,max:1000" />
		</div>
		<div align="center">
			<span>开始时间:</span>
			<input id="st" class="easyui-datetimebox" required="true" value="<?php echo $wzquery['st'];?>" style="width:150px" />
			<span>结束时间:</span>
			<input id="et" class="easyui-datetimebox" required="true" value="<?php echo $wzquery['et'];?>" style="width:150px" />
			<span>车牌号码:</span>
	...
	<script type="text/javascript">
		...
		$('#tt').datagrid({
			...
			url:<?php echo "'".base_url() . 'index.php/logo/load_wzquery'."'";?>,
			method:'post',
			pagination:true, 
			singleSelect:true,
			rownumbers:true, 
