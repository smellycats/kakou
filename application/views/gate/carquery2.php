...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<div>
	<form method="get" action="<?php echo site_url('gate/carquery_ok'); ?>">
	  <div align="center">
	    <table align="center" border="1" cellpadding="2" cellspacing="0" bordercolor="#6AA3C6" class="bg9cf align-left" id="findbox-input-table">
	      ...
	      <tr bordercolor="#E6E6E6">
            ...
            <td colspan="5">
			  <input type="text" name="spcarnum" value="<?php echo $sel_spcarnum;?>" style="height:20px;width:430px"  /><span style="color:blue;font-size: 12px;" >支持多个号牌,逗号分隔</span>
			</td>
			<td align="right">
		...
		<td>
		  <form method="post" action="<?php echo site_url('gate/showdetail'); ?>">
		    ...
		    <div id="find-list">
		        ...
		        <div style="float:right"><label style="font-size:12px;color:#000000"><?php echo anchor('gate/exportexcel/?type_alias='. $sel_type_alias . '&lane=' . $sel_lane . '&direction=' . $sel_direction . '&color=' . $sel_color . '&number=' . $sel_number . '&carnum=' . $sel_carnum . '&starttime=' . $sel_starttime . '&endtime=' . $sel_endtime . '&spcarnum=' . $sel_spcarnum , '【查询结果导出至Excel】'); ?></label></div>
				<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tab">
					...
					<tr>
						...
						<td height="24" ><div align="center" class="STYLE23"><?php echo anchor('gate/showdetail/'. $row->ID , '查看'); ?>|<?php echo anchor('gate/del_showdetail/' . $row->ID, '删除', 'onclick="return confirm(' . "'确定要删除？'" . ')"'); ?></div></td>
					</tr>
					<?php $rownum += 1;?>
					<?php endforeach; ?>
					<tr>
