...
<body>
	...
	<div id="tb" style="padding:3px">
		<div align="center">
			...
			<span>处理状态:</span>
			<input id="dispose" class="easyui-combobox" style="width:140px"
					url = "<?php echo base_url() . 'index.php/basedata/get_dispose';?>" 
					method = "get" valueField = "id" textField = "text" />		
			<span>报警类型:</span>
			<input id="alarmtype" class="easyui-combobox" style="width:100px"
					url = "<?php echo base_url() . 'index.php/basedata/get_alarmtype';?>" 
		...
		<div align="center">
			<span>开始时间:</span>
			<input id="st" class="easyui-datetimebox" required="true" value="<?php echo $bjquery['st'];?>" style="width:150px" />
			<span>结束时间:</span>
			<input id="et" class="easyui-datetimebox" required="true" value="<?php echo $bjquery['et'];?>" style="width:150px" />
			<span>车牌号码:</span>
	...
	<script type="text/javascript">
		...
		$('#tt').datagrid({
			...
			url:<?php echo "'".base_url() . 'index.php/logo/load_bjquery'."'";?>,
			method:'post',
			pagination:true, 
			singleSelect:true,
			rownumbers:true, 
