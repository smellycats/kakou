		...
		<td><?php
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
				...
				<?php if (!empty($users)): ?>
					...
					<td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">禁用</span></div></td>
				...
				<tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><?php echo anchor('user/edit_user/'.$row->id,'修改')?>|<?php echo anchor('user/del_user/'.$row->id,'删除')?></div></td>
				</tr>
				<?php endforeach; ?>
				<tr>
				<?php else: ?>
