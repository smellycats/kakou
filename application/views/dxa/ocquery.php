...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="94%" valign="bottom"><span class="STYLE12">&nbsp;待销案车辆查询</span></td>
										</tr>
									</table>
								</td>
							</tr>
	...
	<div>
	<form method="get" action="<?php echo site_url('dxa/ocquery_ok'); ?>">
	  <div align="center">
		    ...
		    <div id="find-list">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tab">
					...
					<tr>
						...
						<td height="24" ><div align="center" class="STYLE23"><?php echo anchor('dxa/wl_showdetail/'. $row->ID , '查看'); ?><?php if($role_id == '1'){echo '|'. anchor('gate/del_showdetail/' . $row->ID, '删除', 'onclick="return confirm(' . "'确定要删除？'" . ')"');}else{echo '';} ?></div></td>
					</tr>
					<?php $rownum += 1;?>
					<?php endforeach; ?>
					<tr>
